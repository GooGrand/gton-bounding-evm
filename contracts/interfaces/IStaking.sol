...
interface IStaking {
    ...
    function approveAdmin(address owner, address spender, uint value) external returns (bool);
    function transfer(address to, uint value) external returns (bool);
    function transferAdmin(address from, address to, uint value) external returns (bool);
    ...
    function burnAdmin(address _from, address _to, uint256 _share) external;
}